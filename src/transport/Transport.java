...
public abstract class Transport implements Competitive {
    ...
    public Transport(String brand, String model, Double engineVolume, TranportTypes type/*, String country, String color, Double fuelPercentage, Double maxSpeed, String fuelType*/) {
